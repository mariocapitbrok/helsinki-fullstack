...
cantTotal = cantTm50kg + cantTm15kg + cantTm10kg + cantTm5kg

if (cantTm50kg)
  nuevoPrecioTm50kg = precioTm50kg * (1 - descEnvasada(cantTotal, 'TM', '50kg'))
if (cantTm15kg)
  nuevoPrecioTm15kg = precioTm15kg * (1 - descEnvasada(cantTotal, 'TM', '15kg'))
if (cantTm10kg)
  nuevoPrecioTm10kg = precioTm10kg * (1 - descEnvasada(cantTotal, 'TM', '10kg'))
if (cantTm5kg)
  nuevoPrecioTm5kg = precioTm5kg * (1 - descEnvasada(cantTotal, 'TM', '5kg'))
