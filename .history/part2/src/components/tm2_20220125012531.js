...
function descEnvasada(total, unit, presentation) {
  ...
  if (unit === 'costal' && presentation !== 'granel') {
    if (presentation === '50kg') {
      ...
      if (total >= 20 && total <= 80) return 42222 / 100000
      return 42222 / 100000
    }
    if (presentation === '15kg') {
      ...
      if (total >= 65 && total <= 66) return 42222 / 100000
      return 42222 / 100000
    }
    if (presentation === '10kg') {
      ...
      if (total >= 100 && total <= 400) return 42222 / 100000
      return 42222 / 100000
    }
    if (presentation === '5kg') {
      ...
      if (total >= 200 && total <= 800) return 42222 / 100000
      return 42222 / 100000
    }
  }
}
