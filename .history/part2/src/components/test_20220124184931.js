...
function descEnvasada(total, unit, presentation) {
  ...
  if (unit === 'costal' && presentation !== 'granel') {
    if (presentation === '50kg') {
      ...
      if (total >= 20 && total <= 80) return 42 / 100
      return 42 / 100
    }
    if (presentation === '15kg') {
      ...
      if (total >= 65 && total <= 66) return 42 / 100
      return 42 / 100
    }
    if (presentation === '10kg') {
      ...
      if (total >= 100 && total <= 400) return 42 / 100
      return 42 / 100
    }
    if (presentation === '5kg') {
      ...
      if (total >= 200 && total <= 800) return 42 / 100
      return 42 / 100
    }
  }
}
...
if (cantTm50kg)
  nuevoPrecioTm50kg =
    precioTm50kg * (1 - descEnvasada(cantTm50kg, 'TM', '50kg'))
if (cantTm15kg)
  nuevoPrecioTm15kg =
    precioTm15kg * (1 - descEnvasada(cantTm15kg, 'TM', '15kg'))
if (cantTm10kg)
  nuevoPrecioTm10kg =
    precioTm10kg * (1 - descEnvasada(cantTm10kg, 'TM', '10kg'))
if (cantTm5kg)
  nuevoPrecioTm5kg = precioTm5kg * (1 - descEnvasada(cantTm5kg, 'TM', '5kg'))

if (cantTm50kg) {
  total =
    cantTm50kg * precioTm50kg * (1 - descEnvasada(cantTm50kg, 'TM', '50kg')) +
    cantTm15kg * precioTm15kg * (1 - descEnvasada(cantTm15kg, 'TM', '15kg')) +
    cantTm10kg * precioTm10kg * (1 - descEnvasada(cantTm10kg, 'TM', '10kg')) +
    cantTm5kg * precioTm5kg * (1 - descEnvasada(cantTm5kg, 'TM', '5kg'))
}
