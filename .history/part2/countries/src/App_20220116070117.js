...
const Filter = ({ countries, newFilter }) => {
  const filterArray = newFilter.split(' ')
  const lastIndex = filterArray.length
  console.log(filterArray[0], filterArray[lastIndex])
  filterArray[0] === '[' && filterArray[filterArray.length + 1] === ']'
    ? console.log('exacta')
    : console.log('otra')
