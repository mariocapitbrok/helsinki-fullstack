...
const App = () => {
  /* global BigInt */
  const [good, setGood] = useState(BigInt(0))
  const [neutral, setNeutral] = useState(BigInt(0))
  const [bad, setBad] = useState(BigInt(0))
  const [total, setTotal] = useState(BigInt(0))
  const [average, setAverage] = useState(BigInt(0))
  const [percentage, setPercentage] = useState(BigInt(0))
