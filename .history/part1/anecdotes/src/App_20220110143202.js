...
const App = () => {
  ...
  const handleVote = () => {
    ...
    newSortedVotes = votes.sort((a, b) => b.anecdoteVotes - a.anecdoteVotes)
    console.log(votes, newSortedVotes)
  ...
  return (
    <div>
      ...
      <Anecdote anecdotes={sortedAnecdotes} votes={votes} selected={0} />
    </div>
  )
}
